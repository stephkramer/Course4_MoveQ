...
Transform the data into spatial simple feature (`sf`) object

```{r}
mydf_sf <- st_as_sf(x = animal, ## CED: data.frame(animal) -> bei mir geht's auch ohne data.frame()
                    coords = c("longitude", "latitude"),
                    crs = 4326)#,
                    #sf_column_name = "geometry") ## CED: ebenfalls unnötig da default?
```

```{r}
## and project ## CED: Wieso eigentlich? Und woher kennen sie die Projektion?
