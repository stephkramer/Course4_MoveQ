...
```
More on the issue of moving from proj4 to proj6 in the future:
...
my_fox <- move(x = tt$coords.X, y = tt$coords.Y,
               time=as.POSIXct(tt$timestamp.of.fix,format="%Y-%m-%d %H:%M:%S"),
...
homerange2 <- getverticeshr(kud,percent = 90) #this creates the spatial object
