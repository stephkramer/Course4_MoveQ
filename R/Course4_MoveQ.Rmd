...
## CED: Checked, only those not commented are needed
```
...
anim_proc_plot$count <- 1 ## CED: Gibt es hier wasbessers um Observations pro Stunde zu zählen?
...
hrBootstrap(my_fox, rep = 5, level = 99, unout = "m2", plot = TRUE) ## it is ha, not m2 CED: still wrong?
```
